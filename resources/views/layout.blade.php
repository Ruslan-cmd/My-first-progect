...
<div id="header-wrapper">
    <div id="header" class="container">
        <div id="logo">
            <h1><a href="{{route('layout')}}">SimpleWork</a></h1>
        </div>
        <div id="menu">
            <ul>
                <li class="{{Request::path() === '/' ? 'current_page_item' : '' }}"><a href="{{route('layout')}}" accesskey="1" title="">Homepage</a></li>
                ...
                <li class="{{Request::path() === 'articles' ? 'current_page_item' : '' }}"><a href="{{route('articleSection')}}" accesskey="4" title="">Articles</a></li>
